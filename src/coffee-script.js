...
(function() {
  var Module, SourceMap, binary, child_process, compile, compileFile, ext, fileExtensions, findExtension, fork, formatSourcePosition, fs, getSourceMap, helpers, loadFile, parser, path, sourceMaps, vm, withPrettyErrors, _i, _len,
  ...
  parser.yy.parseError = function(message, _arg) {
    ...
    return helpers.throwSyntaxError(message);
  };
